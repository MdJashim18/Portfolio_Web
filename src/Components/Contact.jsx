  ...
  const contactInfo = [
    {
      ...
      link: 'mailto:jashim@example.com',
      description: 'Send me an email anytime'
    },
    {
      icon: <FaPhone className="text-lg" />,
      title: 'Phone',
      value: '+880 01992578305',
                ...
                <div className="space-y-6">
                  {contactInfo.map((info, index) => (
                    <div
                      ...
                      className={`p-4 rounded-xl border border-base-300 transition-all duration-300 ${
                        hoveredCard === index ? 'bg-primary/5 border-primary/20 shadow-lg' : 'hover:bg-base-300/50'
                      }`}
                    >
                      {info.link ? (
                        <a
              ...
              <div className="card-body p-8">
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="form-control mt-8">
                    <button 
                      type="submit" 
                      className={`btn btn-lg btn-primary gap-3 transform transition-all duration-300 hover:scale-[1.02] ${
