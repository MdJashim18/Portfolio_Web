...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <FaGithub />, href: 'https://github.com/MdJashim18', label: 'GitHub' },
    { icon: <FaLinkedin />, href: 'https://www.linkedin.com/in/mohammadjashimuddinrubel/', label: 'LinkedIn' },
    { icon: <FaFacebook />, href: 'https://www.facebook.com/share/1BEhor8qZ6/', label: 'Facebook' },
  ];
